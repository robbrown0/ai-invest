...
FILES=(
 ('scripts/paper_provision.py',Path('/usr/local/sbin/ai-invest-paper-provision'),0o755,'cd64856e9c6d8c97396d74cb3325fa788fc3062f64b2ce793118a117cbdd350a'),
...
APPROVED_OLD_VERSIONS=(('physical-console-v1',OLD_FILES),('ssh-v1',SSH_OLD_FILES),('ssh-scope-v2',SCOPE_OLD_FILES),('ssh-diagnostic-v3',DIAGNOSTIC_OLD_FILES),('ssh-session-v4',SESSION_OLD_FILES),('ssh-session-v5',SESSION_V5_OLD_FILES),('ssh-session-v6',SESSION_V6_OLD_FILES))
CURRENT_VERSION='ssh-session-v7'
MANIFEST_MODE=0o400
DEPENDENCIES=(
