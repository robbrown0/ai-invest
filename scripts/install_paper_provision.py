...
FILES=(
 ('scripts/paper_provision.py',Path('/usr/local/sbin/ai-invest-paper-provision'),0o755,'ed935259a7031dc582e74216c3c09a701887f91e3303a60d7223edea56ecf39c'),
...
SESSION_V14_OLD_FILES=(
 (Path('/usr/local/sbin/ai-invest-paper-provision'),0o755,'f05af8d246885d5469ac405fbe9b286f98c9b5b902dec9e9068841d340da967a'),
 (LIB/'paper-terminal.py',0o644,'cc065a0790e18eadc62038effb79c66f7990cdd121da6a8c2930b51975f1cf04'),
 (LIB/'paper-storage.py',0o644,'e9a0bd4e7d6405f4df79ca45f1982d01b8c500a21808195d7632729f02009706'),
 (POLICY,0o440,'84c3bdd92fe2582122871c031e970b37ef8ab6c0c11175a66d91f575c6258cc0'),
)
...
SESSION_V16_OLD_FILES=(
 (Path('/usr/local/sbin/ai-invest-paper-provision'),0o755,'995e386db8c2899727d960c6e196b9c9bc0462dd9912037d1779b3249d2d611e'),
 (LIB/'paper-terminal.py',0o644,'cc065a0790e18eadc62038effb79c66f7990cdd121da6a8c2930b51975f1cf04'),
 (LIB/'paper-storage.py',0o644,'e9a0bd4e7d6405f4df79ca45f1982d01b8c500a21808195d7632729f02009706'),
 (POLICY,0o440,'84c3bdd92fe2582122871c031e970b37ef8ab6c0c11175a66d91f575c6258cc0'),
)
SESSION_V17_OLD_FILES=(
 (Path('/usr/local/sbin/ai-invest-paper-provision'),0o755,'4ad61c23304e536c318b60a58b79c1ddd4a1a47267f81efb96f7e66ece831414'),
 (LIB/'paper-terminal.py',0o644,'cc065a0790e18eadc62038effb79c66f7990cdd121da6a8c2930b51975f1cf04'),
 (LIB/'paper-storage.py',0o644,'e9a0bd4e7d6405f4df79ca45f1982d01b8c500a21808195d7632729f02009706'),
 (POLICY,0o440,'84c3bdd92fe2582122871c031e970b37ef8ab6c0c11175a66d91f575c6258cc0'),
)
SESSION_V18_OLD_FILES=(
 (Path('/usr/local/sbin/ai-invest-paper-provision'),0o755,'3ff6967563269ee152ba5de23d774fb1aed4edc715a8c418d3c73b29bbf652ab'),
 (LIB/'paper-terminal.py',0o644,'cc065a0790e18eadc62038effb79c66f7990cdd121da6a8c2930b51975f1cf04'),
 (LIB/'paper-storage.py',0o644,'e9a0bd4e7d6405f4df79ca45f1982d01b8c500a21808195d7632729f02009706'),
 (POLICY,0o440,'84c3bdd92fe2582122871c031e970b37ef8ab6c0c11175a66d91f575c6258cc0'),
)
SESSION_V19_OLD_FILES=(
 (Path('/usr/local/sbin/ai-invest-paper-provision'),0o755,'2d6cb58619a600b4b36da3d3900b594b8c0b36f08b23a5997161576d767f4697'),
 (LIB/'paper-terminal.py',0o644,'cc065a0790e18eadc62038effb79c66f7990cdd121da6a8c2930b51975f1cf04'),
 (LIB/'paper-storage.py',0o644,'e9a0bd4e7d6405f4df79ca45f1982d01b8c500a21808195d7632729f02009706'),
 (POLICY,0o440,'84c3bdd92fe2582122871c031e970b37ef8ab6c0c11175a66d91f575c6258cc0'),
)
SESSION_V20_OLD_FILES=(
 (Path('/usr/local/sbin/ai-invest-paper-provision'),0o755,'3cf6604298ea73a20efb3a6fc5f84f77411a6871564dc226a84b919ebef7c530'),
 (LIB/'paper-terminal.py',0o644,'cc065a0790e18eadc62038effb79c66f7990cdd121da6a8c2930b51975f1cf04'),
 (LIB/'paper-storage.py',0o644,'e9a0bd4e7d6405f4df79ca45f1982d01b8c500a21808195d7632729f02009706'),
 (POLICY,0o440,'84c3bdd92fe2582122871c031e970b37ef8ab6c0c11175a66d91f575c6258cc0'),
)
SESSION_V21_OLD_FILES=(
 (Path('/usr/local/sbin/ai-invest-paper-provision'),0o755,'c8c529a050334a787c17533c4566e117c505cb86eea7490d80a577c9ee3321e4'),
 (LIB/'paper-terminal.py',0o644,'cc065a0790e18eadc62038effb79c66f7990cdd121da6a8c2930b51975f1cf04'),
 (LIB/'paper-storage.py',0o644,'e9a0bd4e7d6405f4df79ca45f1982d01b8c500a21808195d7632729f02009706'),
 (POLICY,0o440,'84c3bdd92fe2582122871c031e970b37ef8ab6c0c11175a66d91f575c6258cc0'),
)
SESSION_V22_OLD_FILES=(
 (Path('/usr/local/sbin/ai-invest-paper-provision'),0o755,'1c18571dee3fb46b844c371c124ddf590332716c38eb7ea8767a3c68ace37dbd'),
 (LIB/'paper-terminal.py',0o644,'cc065a0790e18eadc62038effb79c66f7990cdd121da6a8c2930b51975f1cf04'),
 (LIB/'paper-storage.py',0o644,'e9a0bd4e7d6405f4df79ca45f1982d01b8c500a21808195d7632729f02009706'),
 (POLICY,0o440,'84c3bdd92fe2582122871c031e970b37ef8ab6c0c11175a66d91f575c6258cc0'),
)
SESSION_V23_OLD_FILES=(
 (Path('/usr/local/sbin/ai-invest-paper-provision'),0o755,'13630b3a1f6de218378fd53fbd2d9efdcb6192e208b0e26ecdf1acbe402bb7c6'),
 (LIB/'paper-terminal.py',0o644,'cc065a0790e18eadc62038effb79c66f7990cdd121da6a8c2930b51975f1cf04'),
 (LIB/'paper-storage.py',0o644,'e9a0bd4e7d6405f4df79ca45f1982d01b8c500a21808195d7632729f02009706'),
 (POLICY,0o440,'84c3bdd92fe2582122871c031e970b37ef8ab6c0c11175a66d91f575c6258cc0'),
)
SESSION_V24_OLD_FILES=(
 (Path('/usr/local/sbin/ai-invest-paper-provision'),0o755,'480d5bc00b0cc01858d78925014ac4ef769607978fff86403d9b9363248d2b2d'),
 (LIB/'paper-terminal.py',0o644,'cc065a0790e18eadc62038effb79c66f7990cdd121da6a8c2930b51975f1cf04'),
 (LIB/'paper-storage.py',0o644,'e9a0bd4e7d6405f4df79ca45f1982d01b8c500a21808195d7632729f02009706'),
 (POLICY,0o440,'84c3bdd92fe2582122871c031e970b37ef8ab6c0c11175a66d91f575c6258cc0'),
)
SESSION_V25_OLD_FILES=(
 (Path('/usr/local/sbin/ai-invest-paper-provision'),0o755,'142963a65f48c52441a8b93c41d6a564ddb5c617869584bdc995f37c4c7dc130'),
 (LIB/'paper-terminal.py',0o644,'cc065a0790e18eadc62038effb79c66f7990cdd121da6a8c2930b51975f1cf04'),
 (LIB/'paper-storage.py',0o644,'e9a0bd4e7d6405f4df79ca45f1982d01b8c500a21808195d7632729f02009706'),
 (POLICY,0o440,'84c3bdd92fe2582122871c031e970b37ef8ab6c0c11175a66d91f575c6258cc0'),
)
SESSION_V26_OLD_FILES=(
 (Path('/usr/local/sbin/ai-invest-paper-provision'),0o755,'1762fbfe82a6ccb22adc502ac0c0e39aa8d51ce623ec4d0882fdf831742ac4c4'),
 (LIB/'paper-terminal.py',0o644,'cc065a0790e18eadc62038effb79c66f7990cdd121da6a8c2930b51975f1cf04'),
 (LIB/'paper-storage.py',0o644,'e9a0bd4e7d6405f4df79ca45f1982d01b8c500a21808195d7632729f02009706'),
 (POLICY,0o440,'84c3bdd92fe2582122871c031e970b37ef8ab6c0c11175a66d91f575c6258cc0'),
)
SESSION_V27_OLD_FILES=(
 (Path('/usr/local/sbin/ai-invest-paper-provision'),0o755,'ff7a73d49f8af67f1b39c99010cc3c8fc7644af4c1c04ea06feea7e2b4b9020c'),
 (LIB/'paper-terminal.py',0o644,'cc065a0790e18eadc62038effb79c66f7990cdd121da6a8c2930b51975f1cf04'),
 (LIB/'paper-storage.py',0o644,'e9a0bd4e7d6405f4df79ca45f1982d01b8c500a21808195d7632729f02009706'),
 (POLICY,0o440,'84c3bdd92fe2582122871c031e970b37ef8ab6c0c11175a66d91f575c6258cc0'),
)
SESSION_V28_OLD_FILES=(
 (Path('/usr/local/sbin/ai-invest-paper-provision'),0o755,'4e47564ed69660d9aaf6d231f44f6cb2d5e9fbdba2a68a0060b9be35789340e8'),
 (LIB/'paper-terminal.py',0o644,'cc065a0790e18eadc62038effb79c66f7990cdd121da6a8c2930b51975f1cf04'),
 (LIB/'paper-storage.py',0o644,'e9a0bd4e7d6405f4df79ca45f1982d01b8c500a21808195d7632729f02009706'),
 (POLICY,0o440,'84c3bdd92fe2582122871c031e970b37ef8ab6c0c11175a66d91f575c6258cc0'),
)
SESSION_V29_OLD_FILES=(
 (Path('/usr/local/sbin/ai-invest-paper-provision'),0o755,'fe4c4456fc9697c7142ec6b74158f77d4c702a262cd924c95d6dc51871b11efc'),
 (LIB/'paper-terminal.py',0o644,'cc065a0790e18eadc62038effb79c66f7990cdd121da6a8c2930b51975f1cf04'),
 (LIB/'paper-storage.py',0o644,'e9a0bd4e7d6405f4df79ca45f1982d01b8c500a21808195d7632729f02009706'),
 (POLICY,0o440,'84c3bdd92fe2582122871c031e970b37ef8ab6c0c11175a66d91f575c6258cc0'),
)
SESSION_V30_OLD_FILES=(
 (Path('/usr/local/sbin/ai-invest-paper-provision'),0o755,'4f8874202ca91f061fd7ede42564d0d2f2b54be13fe2601df91c4085e9238d39'),
 (LIB/'paper-terminal.py',0o644,'cc065a0790e18eadc62038effb79c66f7990cdd121da6a8c2930b51975f1cf04'),
 (LIB/'paper-storage.py',0o644,'e9a0bd4e7d6405f4df79ca45f1982d01b8c500a21808195d7632729f02009706'),
 (POLICY,0o440,'84c3bdd92fe2582122871c031e970b37ef8ab6c0c11175a66d91f575c6258cc0'),
)
APPROVED_OLD_VERSIONS=(('physical-console-v1',OLD_FILES),('ssh-v1',SSH_OLD_FILES),('ssh-scope-v2',SCOPE_OLD_FILES),('ssh-diagnostic-v3',DIAGNOSTIC_OLD_FILES),('ssh-session-v4',SESSION_OLD_FILES),('ssh-session-v5',SESSION_V5_OLD_FILES),('ssh-session-v6',SESSION_V6_OLD_FILES),('ssh-session-v7',SESSION_V7_OLD_FILES),('ssh-session-v8',SESSION_V8_OLD_FILES),('ssh-session-v9',SESSION_V9_OLD_FILES),('ssh-session-v10',SESSION_V10_OLD_FILES),('ssh-session-v11',SESSION_V11_OLD_FILES),('ssh-session-v12',SESSION_V12_OLD_FILES),('ssh-session-v13',SESSION_V13_OLD_FILES),('ssh-session-v14',SESSION_V14_OLD_FILES),('ssh-session-v15',SESSION_V15_OLD_FILES),('ssh-session-v16',SESSION_V16_OLD_FILES),('ssh-session-v17',SESSION_V17_OLD_FILES),('ssh-session-v18',SESSION_V18_OLD_FILES),('ssh-session-v19',SESSION_V19_OLD_FILES),('ssh-session-v20',SESSION_V20_OLD_FILES),('ssh-session-v21',SESSION_V21_OLD_FILES),('ssh-session-v22',SESSION_V22_OLD_FILES),('ssh-session-v23',SESSION_V23_OLD_FILES),('ssh-session-v24',SESSION_V24_OLD_FILES),('ssh-session-v25',SESSION_V25_OLD_FILES),('ssh-session-v26',SESSION_V26_OLD_FILES),('ssh-session-v27',SESSION_V27_OLD_FILES),('ssh-session-v28',SESSION_V28_OLD_FILES),('ssh-session-v29',SESSION_V29_OLD_FILES),('ssh-session-v30',SESSION_V30_OLD_FILES))
CURRENT_VERSION='ssh-session-v31'
MANIFEST_MODE=0o400
DEPENDENCIES=(
