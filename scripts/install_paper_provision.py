...
FILES=(
 ('scripts/paper_provision.py',Path('/usr/local/sbin/ai-invest-paper-provision'),0o755,'44fa2a4ba8e0af3f9dbd6b684e8ab478d7afbc74c2f53cffc378299fc8894ea2'),
...
APPROVED_OLD_VERSIONS=(('physical-console-v1',OLD_FILES),('ssh-v1',SSH_OLD_FILES),('ssh-scope-v2',SCOPE_OLD_FILES),('ssh-diagnostic-v3',DIAGNOSTIC_OLD_FILES),('ssh-session-v4',SESSION_OLD_FILES),('ssh-session-v5',SESSION_V5_OLD_FILES),('ssh-session-v6',SESSION_V6_OLD_FILES),('ssh-session-v7',SESSION_V7_OLD_FILES))
CURRENT_VERSION='ssh-session-v8'
MANIFEST_MODE=0o400
DEPENDENCIES=(
