...
class Boundaries(unittest.TestCase):
    ...
    def test_ssh_environment_keeps_path_incidental_and_rejects_term_modes(self):
        ...
        with patch.dict(P.os.environ,dict(safe,SSH_ORIGINAL_COMMAND='id'),clear=True): P.require_ssh_environment()
    ...
    def test_terminal_predicate_failure_is_symbolic(self):
        with patch.object(P.os,'isatty',return_value=False):
            with self.assertRaises(P.StageFailure) as ctx: P.require_ssh_terminal({})
...
class Installation(unittest.TestCase):
    ...
    def test_approved_ssh_predecessor_hashes_are_allowlisted(self):
        ...
        self.assertEqual(I.CURRENT_VERSION,'ssh-session-v26')
